...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: site.assets?.ogImage ? [{ url: site.assets.ogImage, width: 1200, height: 630, alt: "Estetisk Glow – Hjem" }] : undefined,
  },
};
  ...
  return (
    <>
      <Hero
        ...
        image="/hero3.png"
        imageAlt="Estetisk Glow klinikk – estetiske behandlinger i Oslo"
       fullHeight={false}
        align="left"
        priority
